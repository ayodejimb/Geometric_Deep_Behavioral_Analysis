...
for opt, data in all_dist.items():    
    ...
    save_att = r'C:\Desktop\with_attention\both_attn_results_OR\2M\{}'.format(opt)
    os.makedirs(save_att, exist_ok=True)
    file_path = r"C:\Downloads\MATLAB_DATA_FOLDERS\2_MONTHS\{}\classsification_attn_results.json".format(opt)
