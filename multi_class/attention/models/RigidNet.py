...
from att_module_1.attention import module_1
from att_module_2.attention_2 import module_2
...
class RigidNet60(nn.Module):
    def __init__(self, mod = 'RigidTransform', num_frames = 7000, num_joints = 8, param=110, run=0):
        ...
        self.att = module_1(channels=num_frames, r=10)
        self.att_2 = module_2(channels=3072, r=2)
